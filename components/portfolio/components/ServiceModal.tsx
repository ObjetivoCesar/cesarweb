      ...
      >
        ...
        <div className="p-6 overflow-y-auto" style={{ maxHeight: 'calc(90vh - 200px)' }}>
          ...
          <div className="p-6 pt-0 text-center">
            <button
              className="px-8 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors w-full sm:w-auto"
              onClick={() => {
                // Aquí puedes agregar la lógica para contactar o contratar el servicio

    ...
    <footer className="bg-[#121212] text-gray-200 border-t border-neutral-800 py-8">
      <div className="container mx-auto flex flex-col md:flex-row items-center md:justify-between gap-6 px-4 md:px-0">
        ...
        <nav className="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2 text-sm mb-4 md:mb-0">
          ...
          <Link href="/maspacientes" className="hover:underline text-gray-300" target="_blank" rel="noopener noreferrer">Maspacientes</Link>
        ...
        <div className="flex flex-col items-center md:items-end text-center md:text-right gap-2">
          <div className="flex space-x-4">
            ...
            <a href="https://wa.me/593963425323?text=Hola%20C%C3%A9sar)" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-gray-400 hover:text-white text-lg">
